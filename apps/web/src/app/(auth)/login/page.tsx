...
function LoginPage() {
  ...
  return (
    <main className="bg-page dark:bg-grid-white/[0.2] bg-grid-black/[0.2] flex h-full min-h-screen w-screen flex-col items-center justify-center space-y-3 overflow-y-auto overflow-x-hidden py-8">
