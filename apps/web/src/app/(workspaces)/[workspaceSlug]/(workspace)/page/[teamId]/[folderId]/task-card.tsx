        ...
        >
          ...
          <div className="flex flex-col gap-0.5">
            {(task.assignee || editMode) && (
              <MemberMultiSelect preset={task.assignee} />
            )}
            {(task.due || editMode) && <DateTimePicker preset={task.due} />}
      ...
      <SheetContent className="flex w-full flex-col pb-3 sm:max-w-lg">
        <ScrollArea>
          ...
          <div className="flex flex-col gap-1">
            <MemberMultiSelect bigger preset={task.assignee} />

            <DateTimePicker bigger preset={task.due} />
